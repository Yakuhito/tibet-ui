  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <meta name="description" content="Unleash DeFi potential with TibetSwap: Chia's first AMM exchange. Swap, provide liquidity, and farm yield easily. Start trading today!" />
