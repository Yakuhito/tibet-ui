...
const faqs = [
  ...
  },
  {
    ...
    answer: 'Simply use <a href="/deploy" rel="noopener noreferrer" class="underline hover:text-gray-700">this page</a> to deploy a pair. If you have any questions, please reach out to <a href="https://x.com/yakuh1t0" target="_blank" rel="noopener noreferrer" class="underline hover:text-gray-700">yakuhito</a>.',
  },
  {
