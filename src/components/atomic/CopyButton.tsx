...
const CopyButton = ({ copyText, children }: CopyButtonProps) => {
  ...
  return (
    <button onClick={handleCopy} ref={buttonRef} className={`${isCopied ? 'cursor-default bg-green-700/20 text-green-700' : 'cursor-pointer text-brandDark dark:text-brandLight hover:opacity-80'} bg-brandDark/10 text-center font-medium py-1 flex items-center justify-center gap-2 px-4 whitespace-nowrap rounded-lg`}>
