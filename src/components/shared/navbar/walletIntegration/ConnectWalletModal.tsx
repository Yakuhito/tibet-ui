    ...
    return (    
        <Modal isOpen={isOpen} setIsOpen={setIsOpen} title="Connect Wallet">
            ...
            <div className="flex flex-col gap-4">
                ...
                {/* Goby Wallet */}
                <div>
                    <div onClick={() => walletManager.connect("Goby")} className={`${gobyActive ? 'bg-green-700/20 focus:ring-green-700/20' : 'bg-brandDark/10'} ${isWalletOnWrongChain && gobyActive ? 'rounded-t-xl' : 'rounded-xl'} hover:opacity-80 group flex items-center justify-between border-2 border-transparent hover:border-brandDark/10 py-4 px-4 cursor-pointer`}>
                    <div className="flex items-center gap-4">
                ...
                {/* Hoogii Wallet */}
                <div>
                    <div onClick={() => walletManager.connect("Hoogii")} className={`${hoogiiActive ? 'bg-green-700/20 focus:ring-green-700/20' : 'bg-brandDark/10'} ${isWalletOnWrongChain && hoogiiActive ? 'rounded-t-xl' : 'rounded-xl'} hover:opacity-80 group flex items-center justify-between border-2 border-transparent hover:border-brandDark/10 py-4 px-4 cursor-pointer`}>
                    <div className="flex items-center gap-4">
