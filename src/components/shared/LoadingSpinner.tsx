...
function LoadingSpinner({ color, width }: LoadingSpinnerProps) {
    return ( 
        <span className="text-brandLight">
            <svg style={{ width: width }} className={`${color ? color : 'text-brandLight'} w-8 h-8 animate-spin`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
