                    ...
                    <div className="flex flex-col max-h-full">
                      ...
                      >
                        <ul className="flex flex-col text-6xl font-medium gap-4">
                          <li className="hover:pl-1 hover:text-brandDark transition-all" onClick={() => setIsOpen(false)}><Link className="focus:outline-none" href="/">Trade</Link></li>
                          <li className="hover:pl-1 hover:text-brandDark transition-all" onClick={() => setIsOpen(false)}><Link className="focus:outline-none" href="/faq">FAQ</Link></li>
                          <li className="hover:pl-1 hover:text-brandDark transition-all" onClick={() => setIsOpen(false)}><Link className="focus:outline-none" href="https://info.v2.tibetswap.io/">Info</Link></li>
                        </ul>
                      </Transition.Child>
