type DexieDuckIconProps = {
  className?: string;
}

function DexieDuckIcon({ className="w-8 h-8" }: DexieDuckIconProps) {
  return (
    <svg
      version="1.0"
      ...
      width="635.000000pt"
      height="710.000000pt"
      viewBox="0 0 635.000000 710.000000"
    >
      <g
      ...
      >
        <path
          d="M3347 6639 c-330 -27 -565 -181 -788 -518 -176 -266 -274 -557 -300
